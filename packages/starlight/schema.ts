...
const StarlightFrontmatterSchema = (context: SchemaContext) =>
	z.object({
		 ...
		 */
		editUrl: z.union([z.url(), z.boolean()]).optional().prefault(true),
		 ...
		 */
		template: z.enum(['doc', 'splash']).prefault('doc'),
		...
		pagefind: z.boolean().prefault(true),
		 ...
		 */
		draft: z.boolean().prefault(false),
	});
